...
const draw = (text, id, version) => {
  _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("rendering info diagram\n" + text);
  const svg = (0,_mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.z)(id);
  (0,_mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.i)(svg, 100, 400, true);
